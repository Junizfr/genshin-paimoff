...
import { allRoles } from './models/role.js';
    ...
    try {
      ...
      users.forEach((dataUser) => {
        ...
        <tr>
          ...
          <td class="actions-cell">
            <button class="action-icon edit" id="editUser${dataUser.id}">                                
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
              </svg>
            </button>
            <button class="action-icon delete" id="deleteUser${dataUser.id}">                               
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path d="M3 6h18"></path>
                <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"></path>
                <path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path>
      ...
      usersBody.innerHTML = `<tr><td colspan="3">Erreur de chargement</td></tr>`;
    } finally {
